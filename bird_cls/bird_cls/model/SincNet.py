...
class SincConv_fast(nn.Module):
    ...
    def __init__(self, out_channels, kernel_size, sample_rate=16000, in_channels=1,
                 stride=1, padding=0, dilation=1, bias=False, groups=1, min_low_hz=2000, min_band_hz=50):
...
if __name__ == '__main__':
    ...
    dnn2_net = MLP(dnn2_options)
    sincnet = SincNet(options)
    x = torch.randn(10, 6400)
    y = dnn2_net(dnn1_net(sincnet(x)))
